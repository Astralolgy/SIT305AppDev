...
public class LostFoundItemDB  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sqlDB = "CREATE TABLE LostFoundItems (id TEXT PRIMARY KEY, type TEXT, itemName TEXT, contact TEXT, description TEXT, time TEXT, lng TEXT, lat TEXT)";
        db.execSQL(sqlDB);
    }
    ...
    public Boolean addItem(LostFoundItem lostfoundItem)
    {
        ...
        cal.put("lng", lostfoundItem.getLng());
        cal.put("lat", lostfoundItem.getLat());
    ...
    public LostFoundItem getItems(String id)
    {
        ...
        Cursor query = sql_DB.query(TABLE_NAME, new String[] {"id", "type", "itemName", "contact", "description", "time", "lng", "lat"},
                "id=?", new String[]{id}, null, null, null, null);
        if (query != null)
        {
            query.moveToFirst();
        }
        LostFoundItem lostFoundItem = new LostFoundItem(query.getString(0), query.getString(1), query.getString(2), query.getString(3), query.getString(4), query.getString(5), query.getString(6), query.getString(7));
        query.close();
        sql_DB.close();
    ...
    public List<LostFoundItem> getAllItem()
    {
        ...
        {
            result.add(new LostFoundItem(query.getString(0), query.getString(1), query.getString(2), query.getString(3), query.getString(4), query.getString(5), query.getString(6), query.getString(7)));
        }
        query.close();
        sql_DB.close();
        return result;
