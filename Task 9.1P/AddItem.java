...
public class AddItem extends AppCompatActivity {
    ...
    EditText itemName, contact, itemDesc, itemWhen, itemLng, itemLat;
    Button backButton;
    Button saveButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemLng = findViewById(R.id.lngText);
        itemLat = findViewById(R.id.latText);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lng = itemLng.getText().toString();
                String lat = itemLat.getText().toString();

                if (name.isEmpty() && details.isEmpty() && desc.isEmpty() && when.isEmpty() && lng.isEmpty() && lat.isEmpty())
                {
                ...
                LostFoundItem lostFoundItem = new LostFoundItem(randomID, type, name, details, desc, when, lng, lat);
